...
public class OurCcdata1 implements Serializable {
	// 主键id
	private Integer id;
	// 冷藏箱编号
	...
	public OurCcdata1(Integer id, String containerId, String deviceId,
			...
			String backDoorState, String gpsPosition, Integer railId) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OurCcdata1 other = (OurCcdata1) obj;
	...
	public String toString() {
		return "OurCcdata1 [id=" + id + ", containerId=" + containerId
				...
				+ ", gpsPosition=" + gpsPosition + ", railId=" + railId + "]";
	}
